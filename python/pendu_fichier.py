...
les_mots_str = ""
# ouvrir le fichier des mots
fichier_mots = open("mots_pendu.txt","r")
les_mots_str = fichier_mots.read()
fichier_mots.close()
   
# transformer la str en list
les_mots = les_mots_str.split("\n")
...
while continuer:
    ...
    while not gagne and not perdu:
        ...
        # demande une lettre
        lettre_joueur = input("Choisis une lettre !\n")
    ...
    # continuer ?
    reponse = input("Veux tu continuer à jouer ? [O/N]\n")
    if reponse in "Nn":
        continuer = False
